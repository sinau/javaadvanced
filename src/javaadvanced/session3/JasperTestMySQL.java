...
public class JasperTestMySQL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport("/home/kakashi/JaspersoftWorkspace/MyReports/cobamysql.jasper", parameters, mysqlDataSource.getConnection());			
